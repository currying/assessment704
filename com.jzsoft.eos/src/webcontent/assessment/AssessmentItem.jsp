...
<body>
	...
	<div id="itemTreeGrid" class="nui-treegrid" style="width:100%;height:400px;"
	    showTreeIcon="true" showCheckbox="true"
	    ...
	    onLoad="onItemTreeGridLoad"
	    
	    treeColumn="name" idField="id"
	    allowResize="true"  fitColumns="false" dataField="items">
