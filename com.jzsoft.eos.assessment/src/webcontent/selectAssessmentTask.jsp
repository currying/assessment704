...
<body style="width: 98%; height: 95%;">
	<div style="width: 1%; height: 1%;">
		<div id="AssessmentTaskForm" class="nui-form" align="center"
			style="height: 100%">
			<!-- 数据实体的名称 -->
			<input class="nui-hidden" name="criteria/_entity"
				value="com.jzsoft.eos.dataset.AssessmentTask">
		</div>
	</div>
	<div class="nui-fit">
		<div id="datagrid1" dataField="assessmenttasks" class="nui-datagrid"
			style="width: 100%; height: 90%;"
			url="com.jzsoft.eos.assessmenttaskbiz.queryAssessmentTasks.biz.ext"
			pageSize="10" showPageIndex="true" onrowdblclick="onRowDblClick">
			<div property="columns">
				<div type="indexcolumn" headerAlign="center">序号</div>
				<div field="id" headerAlign="center" allowSort="true"
					visible="false">考核任务标识</div>
				<div field="name" headerAlign="center" allowSort="true">考核任务</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		var formData = new nui.Form("#AssessmentTaskForm")
				.getData(false, false);
		grid.load(formData);
