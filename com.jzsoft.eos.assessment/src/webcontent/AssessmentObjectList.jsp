...
<body style="width: 98%; height: 93%;">
	<div class="nui-panel" title="考核对象查询" iconCls="icon-add"
		...
		<div id="AssessmentObjectForm" class="nui-form" align="center"
			...
			<input class="nui-hidden" name="criteria/_entity"
				value="com.jzsoft.eos.assessment.dataset.AssessmentObject">
			<!-- 排序字段 -->
			<table id="table1" class="table" style="height: 100%">
				<tr>
					<td class="form_label">考核对象名:</td>
	...
	<div class="nui-panel" title="AssessmentObject列表" iconCls="icon-add"
		...
		<div class="nui-fit">
			<div id="datagrid1" dataField="assessmentObjects"
				class="nui-datagrid" style="width: 100%; height: 100%;"
				url="com.jzsoft.eos.assessment.assessmentObjectBiz.queryAssessmentObjects.biz.ext"
						...
						.confirm(
								...
								function(action) {
									if (action == "ok") {
										...
										$
												.ajax({
													url : "com.jzsoft.eos.assessment.assessmentObjectBiz.deleteAssessmentObjects.biz.ext",
													type : 'POST',
													data : json,
													cache : false,
