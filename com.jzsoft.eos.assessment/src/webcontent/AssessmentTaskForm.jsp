...
function onButtonEdit(e) {
            var btnEdit = this;
            nui.open({
                url:"<%=contextPath%>/assessment/selectAssessmentObject.jsp",
				title : "选择列表",
				width : 650,
				height : 380,
		...
		function saveData() {
			...
			//保存
			var urlStr = "com.jzsoft.eos.assessmentTaskBiz.addAssessmentTask.biz.ext";
